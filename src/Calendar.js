...
class Calendar extends React.Component {
  static propTypes = {
     ...
     * @type Calendar.Views ('month'|'week'|'gantt'|'work_week'|'day'|'agenda')
     * @default 'month'
     */
     ...
     *
     * ```js
     * (dates: Date[] | { start: Date; end: Date }, view: 'month'|'week'|'gantt'|'work_week'|'day'|'agenda'|undefined) => void
     * ```
     *
  ...
  static defaultProps = {
    ...
    toolbar: true,
    view: views.MONTH,
    views: [views.MONTH, views.WEEK, views.DAY, views.AGENDA, views.GANTT],
    step: 30,
    length: 30,
   ...
   * @param date
   * @param viewComponent
   * @param {'month'|'week'|'gantt'|'work_week'|'day'|'agenda'} [view] - optional
